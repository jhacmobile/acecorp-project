...
const AceGasLogo: React.FC<AceGasLogoProps> = ({ 
  className, 
  color = '#0ea5e9', 
  customUrl, 
  inverted 
  ...
  if (customUrl) {
    return <img src={customUrl} alt="AceGas Logo" className={`${className} object-contain`} />;
  }
