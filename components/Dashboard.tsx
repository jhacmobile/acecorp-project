               ...
               <table className="w-full text-left text-[11px] border-collapse mb-12">
                  <thead>
                     <tr className="border-b-4 border-slate-950 text-slate-950">
                        ...
                        <th className="py-4 uppercase font-black tracking-widest w-32">Ticket #</th>
                        <th className="py-4 uppercase font-black tracking-widest">Customer / Entity</th>
                        <th className="py-4 uppercase font-black tracking-widest w-32">Operator</th>
                        <th className="py-4 uppercase font-black tracking-widest text-center w-24">Status</th>
                        <th className="py-4 uppercase font-black tracking-widest text-right w-32">Settlement</th>
                     </tr>
                  </thead>
