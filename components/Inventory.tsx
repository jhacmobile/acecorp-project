          ...
          <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md flex items-center justify-center z-[5000] p-4">
             <div className="bg-white w-full max-w-7xl h-[90vh] rounded-[48px] shadow-2xl flex flex-col overflow-hidden animate-in zoom-in duration-300">
                ...
                <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
                   ...
                   <div className="w-full lg:w-[440px] py-2 px-6 shrink-0 flex flex-col">
                      <div className="flex-1 bg-slate-950 flex flex-col rounded-[40px] p-8 relative overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.4)]">
                         ...
                         <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="flex-1 overflow-y-auto custom-scrollbar space-y-6 flex flex-col justify-center">
                               {dispatchDraft.length === 0 && returnDraft.length === 0 ? (
                                  <div className="py-10 text-center opacity-30 grayscale">
                                     ...
                                     <p className="text-[10px] font-black text-white uppercase tracking-widest">Empty Registry</p>
                                  </div>
                               ) : (
                                  <>
