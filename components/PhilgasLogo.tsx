...
const PhilgasLogo: React.FC<PhilgasLogoProps> = ({ 
  className, 
  color = '#0ea5e9', 
  customUrl, 
  inverted 
  ...
  if (customUrl) {
    return <img src={customUrl} alt="Philgas Logo" className={`${className} object-contain`} />;
  }
